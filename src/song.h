...
class Song
{
    ...
    public:
        ...
        Song() : acousticness(0), danceability(0), duration_ms(0), energy(0), _explicit(false), id(""), instrumentalness(0), key(0), liveness(0), loudness(0), mode(false), name(""), popularity(0), date(0), speechiness(0), tempo(0), year(0), happiness(0), distance(0) {}
